...
const PRINCIPLES: readonly Principle[] = [
  {
    ...
    body: 'The child taps the chocolate first — splits it, finds a half, finds a quarter, covers a half with two quarters. The names sit alongside the action, never replace it.',
    demo: <DemoConcrete />,
    reverse: false,
  },
  {
  ...
  },
  {
    ...
    body: 'Introduce → recognize → recall. A canonical Montessori sequence that maps cleanly onto our six beats. Recall is the material itself — cover the half with two quarters, then fold a paper to prove it again.',
  ...
  },
  {
    ...
    body: 'Introduce on a bar. Recognize on a mixed mat. Recall on a sheet of paper. The tray reshapes per period — only what the child needs sits in front of them.',
  ...
  },
  {
    ...
    body: 'When the child picks wrong, every hint points back to the material. Never “you’re wrong” — always “that’s a quarter — find the half”.',
    demo: <DemoRedirect />,
    reverse: true,
  },
];
